...
import cv2
from eva.utils.vision.identifier import Identifier
...
class Describer:
    ...
    def _create_ollama_model(self, model_name: str):
        from eva.utils.vision.model_ollama import OllamaVision
        
        return OllamaVision(model_name, self._base_url)
    
    def _create_openai_model(self):
        from eva.utils.vision.model_openai import OpenAIVision
        
        return OpenAIVision()
    
    def _create_groq_model(self):
        from eva.utils.vision.model_groq import GroqVision
